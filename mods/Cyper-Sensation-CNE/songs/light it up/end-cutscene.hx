...
function playvideo(videoname) {
	trace('playvide');
	if (video.load('mods/' + ModsFolder.currentModFolder + '/videos/CH3/' + videoname + '.mp4'))
...
function create() {
	...
	jsonString = Paths.file('videos/CH3/' + videoname + sublang + '.json');
	...
	cutva = FlxG.sound.load(Paths.sound('cutscene/ch3/' + videoname + dublang), 1);
