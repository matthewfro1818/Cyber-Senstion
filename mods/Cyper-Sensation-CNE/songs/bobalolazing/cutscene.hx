...
function create() {
	if(!cutended)
	{
		...
		longshort = new FunkinText(525, 547, 0, "BOTPLAY", 37, true);
		...
		longshort.text = "(Long Story Short Time!!)\nBasically! Talia just take a break from work and go do researc-\nI mean have fun by travel to random world!\n\n[Press A To Continue]
		";
